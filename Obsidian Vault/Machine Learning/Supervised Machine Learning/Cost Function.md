---
tags:
  - mahcine_learning/supervised_learning
---
### Idea
...
>[!note]
> A surprising connection, the cost function is also the [[Maximum Likelihood Estimator]] in this case, therefore the MSE = MLE = Cost. 
