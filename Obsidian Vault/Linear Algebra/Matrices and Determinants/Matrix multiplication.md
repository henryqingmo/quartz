...
This is basically Row Picture and Column Picture in [[Systems of Linear Equations]]
...
For `MM4` we used `V2` to breakup into column row products which are matrices.
